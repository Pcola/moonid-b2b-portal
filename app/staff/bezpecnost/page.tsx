    ...
    <div className="flex max-w-[720px] flex-col gap-5">
      ...
      <div className="rounded-2xl border border-line bg-white p-6">
        <div className="mb-4 flex items-center gap-2.5">
          <span className={`inline-flex h-9 w-9 items-center justify-center rounded-[10px] ${enrolled ? "bg-success text-success-ink" : "bg-cream text-muted"}`}>
          ...
          <div>
            ...
            <div className={`text-[13px] ${enrolled ? "text-success-ink" : "text-muted-2"}`}>{enrolled ? "Aktívne — pri prihlásení sa vyžaduje kód" : "Neaktívne"}</div>
          </div>
        </div>
