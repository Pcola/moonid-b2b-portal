    ...
    <div className="max-w-[1100px]">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-none gap-2">
          <Link href="/staff/katalog/parovanie" className="inline-flex items-center gap-1.5 rounded-[10px] border border-line px-4 py-2.5 text-[14px] font-semibold text-brand transition hover:border-brand">Manuálne párovanie</Link>
          <Link href="/staff/katalog/novy" className="inline-flex items-center gap-1.5 rounded-[10px] bg-brand px-4 py-2.5 text-[14px] font-semibold text-white transition hover:bg-brand-2">+ Pridať produkt</Link>
        </div>
      </div>
