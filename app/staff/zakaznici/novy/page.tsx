...
export default async function NewCustomerPage() {
  ...
  // STAFF onboarduje na základnej úrovni; zľavovú prideľuje ADMIN (createCustomer to vynúti).
  ...
  return (
    <div className="flex max-w-[760px] flex-col gap-5">
      ...
      <NewCustomerForm tiers={tiers.map((t) => ({ code: t.code, name: t.name, discountPct: Number(t.discountPct) }))} canEditPricing={canEditPricing} />
    </div>
  );
}
