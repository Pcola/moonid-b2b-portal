...
export function AccessConfirmation() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {error && <div role="alert" className="rounded-[10px] border border-[#f0c9c2] bg-[#fdecea] px-3.5 py-2.5 text-[13.5px] text-[#9a3025]">{error}</div>}
      <button ref={buttonRef} type="button" onClick={confirm} disabled={pending || !token}
